...
const rooms = [
  {
    ...
    savings: "₦10,000",
    image:
      "https://images.unsplash.com/photo-1611892440504-42a792e24d32?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHwzZCUyMHJlbmRlciUyMGJlZHJvb218ZW58MXx8fHwxNzY5NTk5MTMyfDA&ixlib=rb-4.1.0&q=80&w=1080",
    features: ["Kitchenette", "Living Area", "Free Wi-Fi", "Air Conditioning"],
  },
  {
    id: 2,
    name: "Deluxe Suite",
...
export function RoomsSection({ onBookNow }: RoomsSectionProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Experience comfort and luxury in our well-appointed rooms. Book
        ...
        <div className="bg-gradient-to-r from-green-600 to-green-500 text-white py-6 px-8 rounded-lg mb-12 text-center shadow-xl">
          ...
          <p className="text-lg">
            Save up to <span className="text-3xl font-bold">₦15,000</span> per
            night when you book direct!
          </p>
        </div>
        ...
        <div className="mt-16 bg-white p-8 rounded-lg shadow-md">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-center">
            <div>
              <h4 className="font-bold text-[#1e3a5f] text-lg mb-2">
                Check-in Time
              </h4>
